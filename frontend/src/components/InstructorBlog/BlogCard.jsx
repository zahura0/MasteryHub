...
export default function BlogCard({ blog }) {
  return (
    <Link
      ...
      className="group flex h-full flex-col rounded-2xl bg-white border border-gray-200 hover:border-indigo-300 overflow-hidden shadow-sm hover:shadow-lg transition"
    >
      ...
      <div className="p-4 flex flex-col flex-1">
        ...
        <div className="pt-3 flex items-center justify-between text-xs text-gray-500 mt-auto">
