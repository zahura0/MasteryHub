  ...
  return (
    <div className="bg-gray-100 rounded-l p-2 overflow-hidden w-64 flex-shrink-0">
      ...
      <div className="p-4 flex flex-col items-center">
        ...
        <button className="mt-4 flex items-center gap-2 bg-blue-900 text-white font-bold py-3 px-8 rounded-full">
          {buttonText}
          <ArrowDownIcon className="w-5 h-5"  strokeWidth={5}/>
        </button>
      </div>
    </div>
  );
