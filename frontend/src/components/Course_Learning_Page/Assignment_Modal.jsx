...
const Assignment_Modal = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black/50 z-50">
      <div className="bg-white rounded-lg shadow-lg p-10 max-w-4xl w-full grid grid-cols-1 md:grid-cols-2 gap-6 relative">
        {/* Assignment Details */}
        <div>
          <h2 className="text-2xl font-bold mb-2">Java Assignment</h2>
          <p className="text-gray-600 mb-2">Mr. Jone Smith</p>
          <hr className="mb-4 border-gray-400" />
          <p className="text-gray-600 mb-4">
            Dear Student, <br />
            Please complete your Java assignment and submit it along with a text
            document that includes your database details.
          </p>

          <div className="border border-gray-400 p-3 rounded-lg flex justify-between items-center">
            <a
              href="/Java_Assignment.pdf"
              download
              className="text-blue-500 font-semibold hover:underline ml-3"
            >
              Java Assignment.pdf
            </a>
          </div>
...
export default Assignment_Modal;
